...
public class MainActivity extends Activity {
    ...
    private static final String CONSUMER_KEY = "2914597424";// 替换为开发者的appkey，例如"1646212860";
    private static final String REDIRECT_URL = "http://www.xinvalue.com";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (MainActivity.accessToken.isSessionValid()) {
            ...
            try {
                Class sso = Class.forName("WeiboAPI");// 如果支持weiboapi的话，显示api功能演示入口按钮
            } catch (ClassNotFoundException e) {
                // e.printStackTrace();
                Log.i(TAG, "WeiboAPI not found");
    ...
    class AuthDialogListener implements WeiboAuthListener {
        ...
        public void onComplete(Bundle values) {
            ...
            if (MainActivity.accessToken.isSessionValid()) {
                ...
                try {
                    Class sso = Class
                            .forName("WeiboAPI");// 如果支持weiboapi的话，显示api功能演示入口按钮
                } catch (ClassNotFoundException e) {
                    // e.printStackTrace();
                    Log.i(TAG, "WeiboAPI not found");
                ...
                api.update("打广告的德国", "90.00", "90.00", new RequestListener() {
                    @Override
                    public void onComplete(String s) {
                        Util.showToast(MainActivity.this, "发送成功！");
                    }
